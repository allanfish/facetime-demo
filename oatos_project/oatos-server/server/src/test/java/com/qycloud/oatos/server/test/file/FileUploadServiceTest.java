 ...
 *
 */
public class FileUploadServiceTest extends BaseFileServiceTest {
	...
	public void fileUpload() throws IOException {
		...
		bean.setUserId(userId3885);
		bean.setEntId(entId);
		bean.setFolderId(New_folder);
		bean.setFileName("jmeter.pdf");
		bean.setType(CommConstants.FILE_TYPE_ONLINEDISK);
		bean.setFileSize(1527808L);
	...
	public void sectionFileUpload() throws Exception {
		FileUploadDTO bean = new FileUploadDTO();
		bean.setUserId(3317L);
		bean.setEntId(3317L);
		bean.setFolderId(3324L);
		bean.setFileName("test102.pdf");
		bean.setType(CommConstants.FILE_TYPE_ONLINEDISK);
