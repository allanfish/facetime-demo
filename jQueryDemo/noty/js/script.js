/* 
 * Authors: Nedim Arabac谋 (http://ned.im), Muhittin 脰zer (http://muhittinozer.com) 
 */
...
$(document)
		.ready(
				function() {
					...
					$
							.getJSON(
									'http://github.com/api/v2/json/commits/list/needim/noty/master?callback=?',
									function(json) {
										$
												.each(
														json.commits,
														function(i, commit) {
															...
															var $link = $(
																	...
																	.attr(
																			'href',
																			'https://github.com/needim/noty/commit/'
																					+ commit.id)
																	.html(
																			commit.message);
															var $url = $(
