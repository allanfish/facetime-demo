...
public class ConfigUtil {
	...
	public static final String FILE_UPLOAD_WORKER_MAX_SIZE = "FileUploadWorkerMaxSize";
	// 日志
	...
	static {
		...
		try {
			inputStream = ConfigUtil.class.getClassLoader().getResourceAsStream("property/config.properties");
